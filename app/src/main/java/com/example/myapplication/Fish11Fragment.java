...
public class Fish11Fragment extends Fragment {
    private AnimationDrawable isAnimation;
    private ImageView img;
    private TextView fishNameTextView;
    private String fishName = "Betta (Betta splendens)";
    private int index = 0;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_fish11, container, false);

        img = view.findViewById(R.id.img);
        fishNameTextView = view.findViewById(R.id.fish_name);

        img.setImageResource(R.drawable.anif1);
