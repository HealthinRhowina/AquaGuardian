...
import androidx.fragment.app.Fragment;
    ...
    public class FishFragment61 extends Fragment {
        private AnimationDrawable isAnimation;
        private ImageView img;
        private TextView fishNameTextView;
        private String fishName = "Zebra Danio (Danio rerio)";
        private int index = 0;
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View view = inflater.inflate(R.layout.fragment_fish61, container, false);

            img = view.findViewById(R.id.img);
            fishNameTextView = view.findViewById(R.id.fish_name);

            img.setImageResource(R.drawable.anif6);
