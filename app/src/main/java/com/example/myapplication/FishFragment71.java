...
import androidx.fragment.app.Fragment;
    ...
    public class FishFragment71 extends Fragment {
        private AnimationDrawable isAnimation;
        private ImageView img;
        private TextView fishNameTextView;
        private String fishName = "Swordtail (Xiphophorus hellerii)";
        private int index = 0;
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            View view = inflater.inflate(R.layout.fragment_fish71, container, false);

            img = view.findViewById(R.id.img);
            fishNameTextView = view.findViewById(R.id.fish_name);

            img.setImageResource(R.drawable.anif7);
