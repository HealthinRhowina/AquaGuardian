...
public class FishFragment21 extends Fragment {
    private AnimationDrawable isAnimation;
    private ImageView img;
    private TextView fishNameTextView;
    private String fishName = "Neon Tetra (Paracheirodon innesi)";
    private int index = 0;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_fish21, container, false);

        img = view.findViewById(R.id.img);
        fishNameTextView = view.findViewById(R.id.fish_name);

        img.setImageResource(R.drawable.anif2);
